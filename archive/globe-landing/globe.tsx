    ...
    <>
      ...
      <div className="flex h-screen items-center justify-center">
        ...
        >
          ...
          />
          <div
            className="absolute left-[350px] top-[90px] h-1 w-1 rounded-full bg-white"
            style={{ animation: "twinkling-long 4s infinite" }}
          />
          <div
            className="absolute left-[200px] top-[290px] h-1 w-1 rounded-full bg-white"
            style={{ animation: "twinkling 3s infinite" }}
          />
          <div
            className="absolute left-[50px] top-[270px] h-1 w-1 rounded-full bg-white"
            style={{ animation: "twinkling-fast 1.5s infinite" }}
          />
          <div
            className="absolute left-[250px] top-[-50px] h-1 w-1 rounded-full bg-white"
            style={{ animation: "twinkling-long 4s infinite" }}
          />
          <div
            className="absolute left-[290px] top-[60px] h-1 w-1 rounded-full bg-white"
            style={{ animation: "twinkling-slow 2s infinite" }}
          />
        </div>
      </div>
